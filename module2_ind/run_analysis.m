...
for i = 1:11,
	for j = 1:7,
		results = csvread(strcat('./module2_', int2str(j), '_output/result_t_' , int2str(tspan(i)), '.txt'));
...
save('module2_ind_3.mat', 'beta3_lst', 'exitflag3_lst', 'rse3_lst', 'bootstrap_index_matrix', 'tmp_in_out_lst_matrix');

load('module2_ind_3.mat')
fileID = fopen('module2_3_bootstrap_params_err.txt', 'w');
